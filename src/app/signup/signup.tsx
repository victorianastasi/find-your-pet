...
export default function SignUp() {
  ...
  const validateInput = (e: React.FocusEvent<HTMLInputElement>) => {
    e.target.value == "" && setInvalid(true);
        ...
        >
          <fieldset className="flex flex-col md:flex-row justify-center items-center flex-wrap gap-8 mx-auto ">
            ...
            <div className="w-full relative">
              ...
              <input
                type="text"
                className={`rounded py-1 px-1 min-w-full text-slate-700 min-h-[36px] ${invalid ? 'border-red-700 border-2' : ''}`}
                name="userName"
                id="userName"
                onChange={changeUser}
                required
              ...
              />
              {invalid && <small className="text-red-700 absolute bottom-[-20px] left-0">Debes completar este campo.</small>}
            </div>
